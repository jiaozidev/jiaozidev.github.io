...
1. 参考[React Native 中文网 搭建开发环境](https://reactnative.cn/docs/next/getting-started.html) 指导搭建

## 问题
### 安装Homebrew
1. 安装[官网](https://brew.sh/)，提示`curl: (17) failed ... `
    
    1.1 新建`brew_install.sh`文件
    
    1.2 打开[网址](https://raw.githubusercontent.com/Homebrew/install/master/install.sh)，并复制内容到`brew_install.sh`文件，内容附在文章末尾。
    
    1.3 打开命令终端并执行`/bin/bash 对应目录下/brew_install.sh`

### 在Android真机运行提示不能从网址下载正确的文件
1.摇一摇进入dev界面
2.进入Dev Setting界面
3.进入Debugging-Debug server host & port for device,设置为本机IP:8081

## 脑图
![开发环境搭建知识点](https://github.com/jiaozidev/resources/blob/master/image/2020-04/RN%E5%BC%80%E5%8F%91%E7%8E%AF%E5%A2%83%E6%90%AD%E5%BB%BA%E8%84%91%E5%9B%BE.png)
